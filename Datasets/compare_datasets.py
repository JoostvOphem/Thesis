...
def get_difference_between_datasets(dataset1, dataset2):
    ...
    # We'll use empirical cumulative distribution functions (ECDF)
    ...
    # Calculate and return the distance between the two distributions
...
def compare_datasets_with_themselves(
    ...
    for i, AI_type in enumerate(AI_types):
        ...
        for j, AI_type2 in enumerate(AI_types):
            ...
            distance = get_difference_between_datasets(dataset1, dataset2)
...
if __name__ == "__main__":
    ...
    #     version='complete',
    #     heatmap_location='Figures/ghostbusters_distance_heatmap.png'
    # )
    ...
    #     version='complete',
    #     heatmap_location='Figures/monolingual_distance_heatmap.png'
    # )
